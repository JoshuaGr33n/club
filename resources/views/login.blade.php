        ...
        <!-- /SECTION TITLE WRAP -->
                 @if ($loginErr = Session::get('login_error'))
                  ...
                  @if ($password_reset_suc = Session::get('password_reset_success'))
                       <div class="alert alert-success" style="green">
        ...
        <form class="form-wrap" action="login" method="post">
          ...
          <div class="form-row">
            ...
            <div class="form-item blue">
              ...
              <input type="text" id="login_email_02" name="email" placeholder="Enter your email here...">
            </div>
            <!-- /FORM ITEM -->
          </div>
          <!-- /FORM ROW -->
          ...
          <div class="form-row">
            <!-- FORM ITEM -->
            <div class="form-item blue">
              <label for="login_pwd_02" class="rl-label">Password</label>
              <input type="password" id="login_pwd_02" name="password" placeholder="Enter your password here...">
            </div>
            <!-- /FORM ITEM -->
          </div>
          <!-- /FORM ROW -->
          ...
          <div class="form-confirm-row">
            ...
            <!-- LINK TEXT -->
            <a href="{{url('forgot-password')}}" class="link-text-form blue">Forgot Password?</a>
            <!-- /LINK TEXT -->
          </div>
          <!-- /FORM CONFIRM ROW -->
