  ...
  <div class="widget-item" style="width:40%;margin:auto">
        ...
        <!-- SECTION TITLE WRAP --> 
         <div class="section-title-wrap violet small-space desktop">
          <h2 class="section-title medium">Chart @if(Auth::user()->status=="admin")<span  style="margin-left:350px"><a href="{{url('manage-chart')}}"  style="width:138px" class="button tiny btn-success">Manage Chart</a><span>@endif</h2>
        ...
        <!-- /SECTION TITLE WRAP -->
         ...
         <div class="table standings full">
          ...
          $chart = Chart::select([DB::raw("SUM(goal) AS total_goal"), DB::raw("SUM(assist) AS total_assist"), DB::raw("SUM(clean_sheet) AS total_clean_sheet"),'member_id'])->where('member_id',$member->id)->groupby('member_id')->first();
          @endphp
   ...
   <div class="widget-item" style="width:80%;margin:auto">
       ...
       <div class="section-title-wrap violet small-space mobile">
          <h2 class="section-title medium">Chart   @if(Auth::user()->status=="admin")<span  style="margin-left:200px"><a href="{{url('manage-chart')}}"  style="width:138px" class="button tiny btn-success">Manage Chart</a><span>@endif</h2>
          <div class="section-title-separator">  </div>
        </div>
        <!-- /SECTION TITLE WRAP -->
